...
public class HoseAdapter implements PriceFetcher {
    ...
    public List<StockPrice> fetch() {
        ...
        List <HoseData> hoseData = new ArrayList<>();
        List <StockPrice> StockPriceList = new ArrayList<>();
        hoseData = hoseLib.getPrices(stockCodes);
        for (HoseData data : hoseData) {
    ...
    private StockPrice convertToStockPrice(HoseData hoseData) {
        ...
        StockPrice stockPrice = new StockPrice(hoseData.getStockCode(), 
